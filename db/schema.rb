...
ActiveRecord::Schema.define(version: 20151128231036) do
  ...
  create_table "colorings", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "coloring_file_name"
    t.string   "coloring_content_type"
    t.integer  "coloring_file_size"
    t.datetime "coloring_updated_at"
  end
